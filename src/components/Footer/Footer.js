...
const navigation = [
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/company/axelerate-advisory/",
    icon: (props) => (
      <svg
...
export default function Footer() {
  return (
    <footer className="bg-white">
      <div className="mx-auto max-w-7xl px-6 sm:px-12 py-4 md:flex md:items-center md:justify-between lg:px-8">
